...
def Test():
    ...
    directory_original_str = "redirections/flowvis-tool/pacificvis2"
    directory_target_str = "redirections/flowvis-tool/pacificvis3"
    directory_target_local_str = "redirections/flowvis-tool/pacificvis3_local"
